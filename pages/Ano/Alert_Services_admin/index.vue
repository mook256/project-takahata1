                        ...
                        <td class="status-column">
                            <div class="status-cell">
                                ...
                                <button v-if="item.editing !== index" @click="editStatus(index)" class="edit-button"
                                    style="background-color: blue; color: white; width: 50px;">
                                    Edit
                                </button>
                            ...
                            <div
                                ...
                                <div class="admin-detail-actions">
                                    ...
                                    <button @click="openPopup(item)" class="edit-button"
                                        style="background-color: blue; color: white; margin-left: 10px;">
                                        Edit
                                    </button>
                                </div>
                            </div>
...
const test_data = async () => {
    try {
        const response = await fetch('http://localhost:8080/api/IT_Repair_data_table', {
            method: 'POST',
            credentials: 'include',
        });
...
const status_update = async (index) => {
    try {
        const response = await fetch('http://localhost:8080/api/IT_Repair_status_choice', {
            method: 'POST',
            body: JSON.stringify({
...
const saveAdminNote = async () => {
    try {
        await fetch('http://localhost:8080/api/save_admin_note', {
            method: 'POST',
            body: JSON.stringify({
