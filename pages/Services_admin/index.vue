          ...
          <div class="relative">
            ...
            <div v-if="dropdownOpen1" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg">
              <router-link to="/appl_yuser/">
                <a class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Register New User</a>
              </router-link>
      ...
      <table class="table">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="detail-admin-column">Results</th>
          ...
          <tr v-for="(item, index) in displayedItems" :key="index">
            ...
            <td class="status-column">
              <div class="status-cell">
                <span v-if="item.editing !== index" :style="{ color: getStatusColor(item.status) }" class="status-text">
                  {{ item.status }}
                </span>
                ...
                <button v-if="item.editing !== index" @click="editStatus(index)" class="edit-button"
                  style="background-color: blue; color: white; width: 50px; margin-right: 10px;">
                  Edit
                </button>
                <div v-if="item.editing === index" class="action-buttons">
                  <button @click="applyEdit(index)" class="apply-button"
                    style="background-color: green; color: white; width: 50px; margin-left: 10px;">
                    Apply
                  </button>
                  <button @click="cancelEdit(index)" class="cancel-button"
                    style="background-color: red; color: white; width: 50px; margin-left: 10px;">
                    Cancel
                  </button>
                </div>
              </div>
