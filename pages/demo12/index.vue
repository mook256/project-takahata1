    ...
    <div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="relative">
                        ...
                        <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg">
                            ...
                            <router-link to="/Alert_Services_admin/">
                ...
                <div class="container box-border mx-auto max-w-prose bg-sky-50 ">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="flex items-center justify-center space-x-2 flex-grow">
                            <button @click="Search_Show"
                                class="rounded-full bg-green-500 text-white px-4 py-2">แสดงตาราง</button>
                        </div>
        ...
        <div>
            ...
            <div class="container box-border mx-auto max-w-prose bg-white p-0.1">
                <div class="text-center mb-8">
                    <div class="flex flex-col items-center ">
                        <h2 class="text-2xl font-semibold ">Report by: {{ selectedTopic }} - Group by: {{ selectedIssue
                            }}</h2>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="search-pagination-container p-4 flex items-center justify-between">
                    ...
                    <div class="search-bar flex items-center">
                        ...
                        <button @click="downloadPDF(item)" class="download-button px-2 py-2 rounded ml-2">Download
                            PDF</button>
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="(item, index) in paginatedData" :key="index">
                                    ...
                                    <td class="requester-column" style="text-align: left;  padding: 8px;">{{
                                        item.requester }}</td>
                                    ...
                                    <td class="detail-column">
                                        ...
                                        <button v-else class="underline decoration-red-600"
                                            @click="showFullDetail(item)">
                                            Show Detail
                                        </button>
                                    </td>
                                    ...
                                    <td class="request-approval-column">
                                        <div class="status-text" :style="{ color: getStatusColor(item.status) }">{{
                                            item.status }} </div>
                                    </td>


                                    <td class="technician-column" style="text-align: left;  padding: 8px;">{{
                                        item.technician }}</td>
        ...
        <div v-if="showFullDetailModal_S" class="modal-overlay">
            <div class="modal-content scrollable-content">
                ...
                <h2 class="title container centered-text">User Services</h2>
...
const downloadPDF = (item) => {
    ...
    let content = {
        startY: 20,
        head: [['Job No', 'EN', 'Requester', 'Section', 'Branch', 'Tel', 'Create Date', 'Detail', 'Technician', 'Results ', 'Closed Date']],
        // body:data,
        styles: { font: 'MyFont'[255, 0, 0] },
