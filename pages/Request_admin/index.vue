  ...
  <div>
      ...
      <table class="table">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="(item, index) in displayedItems" :key="index">
            ...
            <td class="technician-column">{{ item.technician }}</td>
    ...
    <div v-if="showFullDetailModal" class="modal-overlay">
      <div class="modal-content scrollable-content">
        ...
        <h2 class="title centered-text">User Request</h2>
...
const downloadPDF = (index) => {
  ...
  doc.text(`รายชื่อพนังงาน: ${index.requester}`, margin, bottomTextY - 32);
  doc.text(`รายชื่อหัวหน้างาน: ${index.editingApproval}`, margin, bottomTextY - 25);
  doc.text(`รายชื่อพนังงานเจ้าหน้าที่: ${index.technician}`, margin, bottomTextY - 17);
