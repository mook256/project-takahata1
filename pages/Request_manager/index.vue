        ...
        <div class="flex items-center space-x-2">
          ...
          <div class="relative">
            ...
            <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg">
              <router-link to="/Alert_Request_manager/">
          ...
          <tr v-for="(item, index) in filteredItems" :key="index">
            ...
            <td class="request-approval-column">
              <div class="status-cell">
                ...
                <button v-if="item.editingApproval !== index" @click="editApproval(index)" class="edit-button"
...
const Show_On_Table = async () => {
  try {
    const response = await fetch('http://172.29.10.238:8080/api/IT_Request_TableManagerController', {
      method: 'POST',
      body: JSON.stringify({
        manager_section: token.department,
        manager_role: token.role
      }),
      headers: {
