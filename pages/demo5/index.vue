    ...
    <div>
      ...
      <div>
        ...
        <div class="search-bar p-4">
          ...
          <button @click="applySearch" class="search-button px-2 py-2   rounded">Search</button>
          <div>
            <button @click="downloadPDF" class="download-button px-2 py-2  rounded">Download PDF</button>
          </div>
