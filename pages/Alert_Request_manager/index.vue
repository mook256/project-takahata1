<template>
  <div>
        ...
        <div class="flex items-center space-x-2">
          ...
          <div class="relative">
            ...
            <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg">
              ...
              <!-- <router-link to="/Alert_Services_mangger/">
                <a class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Services</a>
              </router-link> -->
              <router-link to="/Alert_Services_mangger/">
                <a class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Services</a>
              </router-link>
              <router-link to="/Request_manager/">
                <a class="block px-4 py-2 text-gray-800 hover:bg-gray-200">List Approved</a>
              </router-link>
            </div>
          </div>
    ...
    <div class="text-center p-4 bg-sky-300">
      <h2 class="text-2xl font-semibold">ระบบแจ้งเตือน Request</h2>
    </div>
