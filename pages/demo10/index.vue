...
const downloadPDF = (index) => {
    ...
    doc.setFontSize(29); // Set font size for the top-right text
    ...
    doc.setFontSize(29); // Set font size for the top-center text
    ...
    // Job details section
    doc.text(`ผู้แจ้ง`, margin, topMargin + spacing + 30 ,);
    ...
    doc.text(`รายละเอียดการแจ้ง`, margin, topMargin + spacing + 90);
    ...
    doc.text(`รายละเอียดไอที`, margin, topMargin + spacing + 170);
    ...
    doc.text(`รายชื่อพนังงานเจ้าหน้าที่: ${index.technician}`, margin, bottomTextY - 25);
    ...
    doc.setFontSize(29); // Set font size for the bottom-left text
